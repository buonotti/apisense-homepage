...
You can also create a definition file via the Apisense API. Just post the definition to the definitions endpoint to create the definition file in remote. Check out [Broken link](broken-reference "mention") to learn more about the available endpoints
