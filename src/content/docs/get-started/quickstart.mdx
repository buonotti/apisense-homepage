...
<LinkCard title="Install" href="/apisense-homepage/get-started/install"/>

Before doing anything you will have to initialize Apisense. This ensures all directories and files needed are set up.
